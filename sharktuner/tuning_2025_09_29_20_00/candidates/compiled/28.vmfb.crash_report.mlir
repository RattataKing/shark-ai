...
module {
  ...
  hal.executable private @main_dispatch_0 {
    hal.executable.variant public @rocm_hsaco_fb target(#executable_target_rocm_hsaco_fb) {
      hal.executable.export public @main_dispatch_0_matmul_8192x8192x8192_f8E4M3FNUZxf8E4M3FNUZxf32 ordinal(0) layout(#pipeline_layout) count(%arg0: !hal.device) -> (index, index, index) {
        %x, %y, %z = iree_tensor_ext.dispatch.workgroup_count_from_slice()
        hal.return %x, %y, %z : index, index, index
      }
      builtin.module {
        func.func @main_dispatch_0_matmul_8192x8192x8192_f8E4M3FNUZxf8E4M3FNUZxf32() {
          %cst = arith.constant 0.000000e+00 : f32
          %c0 = arith.constant 0 : index
          %0 = hal.interface.binding.subspan layout(#pipeline_layout) binding(0) alignment(64) offset(%c0) flags("ReadOnly|Indirect") {iree_gpu.use_rocdl_buffer_instructions} : !iree_tensor_ext.dispatch.tensor<readonly:tensor<8192x8192xf8E4M3FNUZ>>
          %1 = hal.interface.binding.subspan layout(#pipeline_layout) binding(1) alignment(64) offset(%c0) flags("ReadOnly|Indirect") {iree_gpu.use_rocdl_buffer_instructions} : !iree_tensor_ext.dispatch.tensor<readonly:tensor<8192x8192xf8E4M3FNUZ>>
          %2 = hal.interface.binding.subspan layout(#pipeline_layout) binding(2) alignment(64) offset(%c0) flags(Indirect) {iree_gpu.use_rocdl_buffer_instructions} : !iree_tensor_ext.dispatch.tensor<writeonly:tensor<8192x8192xf32>>
          %3 = iree_tensor_ext.dispatch.tensor.load %0, offsets = [0, 0], sizes = [8192, 8192], strides = [1, 1] : !iree_tensor_ext.dispatch.tensor<readonly:tensor<8192x8192xf8E4M3FNUZ>> -> tensor<8192x8192xf8E4M3FNUZ>
          %4 = iree_tensor_ext.dispatch.tensor.load %1, offsets = [0, 0], sizes = [8192, 8192], strides = [1, 1] : !iree_tensor_ext.dispatch.tensor<readonly:tensor<8192x8192xf8E4M3FNUZ>> -> tensor<8192x8192xf8E4M3FNUZ>
          %5 = tensor.empty() : tensor<8192x8192xf32>
          %6 = linalg.fill ins(%cst : f32) outs(%5 : tensor<8192x8192xf32>) -> tensor<8192x8192xf32>
          %7 = linalg.generic {indexing_maps = [#map, #map1, #map2], iterator_types = ["parallel", "parallel", "reduction"]} ins(%3, %4 : tensor<8192x8192xf8E4M3FNUZ>, tensor<8192x8192xf8E4M3FNUZ>) outs(%6 : tensor<8192x8192xf32>) {
  ...
  util.global private mutable @main_dispatch_0_rocm_hsaco_fb_main_dispatch_0_matmul_8192x8192x8192_f8E4M3FNUZxf8E4M3FNUZxf32_buffer : !hal.buffer
  util.initializer {
    ...
    util.global.store %buffer, @main_dispatch_0_rocm_hsaco_fb_main_dispatch_0_matmul_8192x8192x8192_f8E4M3FNUZxf8E4M3FNUZxf32_buffer : !hal.buffer
    util.return
  }
  util.func public @main_dispatch_0_rocm_hsaco_fb_main_dispatch_0_matmul_8192x8192x8192_f8E4M3FNUZxf8E4M3FNUZxf32(%arg0: i32) attributes {iree.abi.stub, iree.reflection = {iree.benchmark = "dispatch"}} {
    %0 = arith.index_cast %arg0 : i32 to index
    %device, %queue_affinity = hal.device.resolve on(#hal.device.affinity<@__device_0>) : !hal.device, i64
    %cmd = hal.command_buffer.create device(%device : !hal.device) mode("OneShot|AllowInlineExecution") categories(Dispatch) affinity(%queue_affinity) : !hal.command_buffer
    %main_dispatch_0_rocm_hsaco_fb_main_dispatch_0_matmul_8192x8192x8192_f8E4M3FNUZxf8E4M3FNUZxf32_buffer = util.global.load @main_dispatch_0_rocm_hsaco_fb_main_dispatch_0_matmul_8192x8192x8192_f8E4M3FNUZxf8E4M3FNUZxf32_buffer : !hal.buffer
    %c0 = arith.constant 0 : index
    ...
    %workgroup_x, %workgroup_y, %workgroup_z = hal.executable.calculate_workgroups device(%device : !hal.device) target(@main_dispatch_0::@rocm_hsaco_fb::@main_dispatch_0_matmul_8192x8192x8192_f8E4M3FNUZxf8E4M3FNUZxf32) : index, index, index
    %exe = hal.executable.lookup device(%device : !hal.device) executable(@main_dispatch_0) : !hal.executable
    %ordinal = hal.executable.export.ordinal target(@main_dispatch_0::@rocm_hsaco_fb::@main_dispatch_0_matmul_8192x8192x8192_f8E4M3FNUZxf8E4M3FNUZxf32) : index
    %c1 = arith.constant 1 : index
    scf.for %arg1 = %c0 to %0 step %c1 {
      hal.command_buffer.dispatch<%cmd : !hal.command_buffer> target(%exe : !hal.executable)[%ordinal] workgroups([%workgroup_x, %workgroup_y, %workgroup_z]) bindings([
        (%main_dispatch_0_rocm_hsaco_fb_main_dispatch_0_matmul_8192x8192x8192_f8E4M3FNUZxf8E4M3FNUZxf32_buffer : !hal.buffer)[%c0, %c67108864], 
        (%main_dispatch_0_rocm_hsaco_fb_main_dispatch_0_matmul_8192x8192x8192_f8E4M3FNUZxf8E4M3FNUZxf32_buffer : !hal.buffer)[%c67108864, %c67108864], 
        (%main_dispatch_0_rocm_hsaco_fb_main_dispatch_0_matmul_8192x8192x8192_f8E4M3FNUZxf8E4M3FNUZxf32_buffer : !hal.buffer)[%c134217728, %c268435456]
      ]) flags("None")
