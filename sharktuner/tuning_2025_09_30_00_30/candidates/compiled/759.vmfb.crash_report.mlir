...
module {
  ...
  hal.executable private @main_dispatch_0 {
    hal.executable.variant public @rocm_hsaco_fb target(#executable_target_rocm_hsaco_fb) {
      hal.executable.export public @main_dispatch_0_matmul_1024x10240x1280_f16xf16xf32 ordinal(0) layout(#pipeline_layout) count(%arg0: !hal.device) -> (index, index, index) {
      ...
      builtin.module {
        func.func @main_dispatch_0_matmul_1024x10240x1280_f16xf16xf32() {
          ...
          %7 = linalg.generic {indexing_maps = [#map, #map1, #map2], iterator_types = ["parallel", "parallel", "reduction"]} ins(%3, %4 : tensor<1024x1280xf16>, tensor<10240x1280xf16>) outs(%6 : tensor<1024x10240xf32>) {
